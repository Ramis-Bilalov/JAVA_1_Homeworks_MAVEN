...
import Lesson7.classwork.Group;
import Lesson7.classwork.Student;
import Lesson7.classwork.Teacher;
...
public class University {
    ...
    public void takeJob(List<Group> groups, Teacher teacher) {
        // groups.forEach(group -> group.addTeacher(teacher));  через стрим
